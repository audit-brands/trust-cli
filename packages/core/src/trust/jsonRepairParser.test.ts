...
describe('JsonRepairParser', () => {
  ...
  describe('parseFunctionCalls', () => {
    it('should parse valid JSON function calls', () => {
      const text =
        '{"function_call": {"name": "list_directory", "arguments": {"path": "/tmp"}}}';
    ...
    it('should fix trailing commas', () => {
      const text =
        '{"function_call": {"name": "test", "arguments": {"key": "value",}}}';
      const result = parser.parseFunctionCalls(text);
    ...
    it('should extract function calls from surrounding text', () => {
      const text =
        'Here is the function call: {"function_call": {"name": "test", "arguments": {}}} and some more text';
      const result = parser.parseFunctionCalls(text);
    ...
    it('should extract from informal patterns', () => {
      const text =
        'Execute tool: read_file with arguments: {"file": "config.json"}';
      const result = parser.parseFunctionCalls(text);
