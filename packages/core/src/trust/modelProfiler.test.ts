...
import { ModelProfiler, WorkloadPattern } from './modelProfiler.js';
import {
  PerformanceMonitor,
  InferenceMetrics,
  SystemMetrics,
...
describe('ModelProfiler', () => {
  ...
  describe('Model Profiling', () => {
    ...
    it('should record inference metrics', async () => {
      await modelProfiler.startModelProfiling('test-model', mockModelConfig);
      await modelProfiler.recordInference(
        'test-model',
  ...
  describe('Optimization Recommendations', () => {
    it('should generate memory optimization recommendations', async () => {
      ...
      const recommendations =
        await modelProfiler.generateOptimizationRecommendations('test-model');
  ...
  describe('Workload Recommendations', () => {
    ...
    it('should return workload recommendations', async () => {
      ...
      const recommendations =
        modelProfiler.getWorkloadRecommendations(mockWorkloadPattern);
    ...
    it('should filter out unsuitable models', async () => {
      ...
      const badModelRec = recommendations.find(
        (r) => r.model.name === 'test-model',
      );
  ...
  describe('Error Handling', () => {
    it('should handle missing model profiles gracefully', async () => {
      ...
      const recommendations =
        await modelProfiler.generateOptimizationRecommendations(
          'nonexistent-model',
        );
