...
> {
  ...
  /**
   * Optional method to summarize tool output using AI
   * @param result The tool execution result
   * @param contentGenerator The content generator (supports Ollama/HuggingFace/Cloud)
   * @param signal Abort signal for cancellation
   * @returns A concise summary of the tool output
   */
  summarizer?: (
    result: TResult,
...
export interface ToolResult {
  ...
  /**
   * Optional AI-generated summary of the tool output
   * Generated by the tool's summarizer method if available
   */
  summary?: string;
}
